    ...
    <>
      <div className="navContainer">
        ...
        <div className={`navContainerModal`} ref={navContainerWidth}>
          <div
            className={`${
              !mobileMenu ? "hide" : "block"
            } navModalLink--container `}
          >
            <Link to="/">
              <IoHome />{" "}
              <span id="home" onClick={() => handleMenuClose()}>
                Home
              </span>
            </Link>
            <Link to="/discover">
              <IoCompassOutline id="discover" />{" "}
              <span onClick={() => handleMenuClose()}>Discover</span>
            </Link>
          </div>
        </div>
      </div>
